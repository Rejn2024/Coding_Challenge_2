...
class ScaleJitter(nn.Module):
    ...
    Args:
        ...
        interpolation (InterpolationMode): Desired interpolation enum defined by
            :class:`torchvision.transforms.py.InterpolationMode`. Default is ``InterpolationMode.BILINEAR``.
    """
...
def _copy_paste(
    ...
    if "iscrowd" in target and "iscrowd" in paste_target:
        ...
        # For example, if previous transforms.py geometrically modifies masks/boxes/labels but
